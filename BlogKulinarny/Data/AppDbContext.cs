...
public class AppDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<RecipesCategory>().HasOne(m => m.recipe).WithMany(am => am.recipesCategories)
            .HasForeignKey(m => m.recipeId);

        modelBuilder.Entity<RecipesCategory>().HasOne(m => m.category).WithMany(am => am.recipesCategories)
