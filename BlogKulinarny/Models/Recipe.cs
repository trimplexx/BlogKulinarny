...
public class Recipe // brakuje relacji z category posts
{
    ...
    public Recipe(bool isAccepted, string title, string imageURL, string description, int difficulty, int avgTime,
        int portions, int userId)
    {
    ...
    [Display(Name = "Difficulty")] public int difficulty { get; set; }

    [Display(Name = "AvgTime")] public int avgTime { get; set; }

    [Display(Name = "Portions")] public int portions { get; set; }

    //user
    [Display(Name = "User")] public int userId { get; set; }
